...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".glazing_slider", ".glazing_link", ".glazing_content", "active");
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(); // tasks: 1,2, 5, 7, 10
});
...
var modals = function modals() {
  function openModal(selector) {
    ...
    document.body.style.overflow = "hidden"; //document.body.classList.add("modal-open"); // use class from bootstrap.css
  ...
  function closeModal(selector) {
    ...
    document.body.style.overflow = ""; //document.body.classList.remove("modal-open"); // use class from bootstrap.css
  }
  ...
  bindModal(".phone_link", ".popup", ".popup .popup_close"); //const timerId = showModalByTime(".popup", 15000);
};
